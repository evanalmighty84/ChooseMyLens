package com.hoya.view
{
	...
	{	
		...
		public function init():void
		{
			...
			var thumbList:XMLList = _xmlData.lens.primaryThumbs.elements("image");
			...
			var imageList:XMLList = _xmlData.lens.primaryImages.elements("image");
			count = imageList.length();
			for(i = 0; i < count; i++)
			{
				imageViewerClip.imageArray.push(imageList[i]); 
			}
			imageViewerClip.titleText = _xmlData.lens.primaryTitle;
			imageViewerClip.copyText = _xmlData.lens.primaryCopy;
			showLoader();
